...
const VelocityStatus = (props) => {
  ...
  const loadData = useCallback(async (spotId) => {
    ...
    try {
      const { data } = await readVelTrend(spotId);
      setData(data);
    } catch (error) {
      console.error(error);
    } finally {
  ...
  return (
    <Card className={props.className}>
      <div className="width-100p flex-column">
        <h6 className="cardTitle">Velocidade</h6>
        <div className="parent-VelAcel text-center">
          ...
          <DashToday
            ...
            redAlarm={data.redAlarm}
            disableAlarm={data.disableAlarm}
            max={data.vertical.maxVel}
            min={data.vertical.minVel}
            value={data.vertical.instantVel}
            unity={"mm/s"}
          ...
          <DashToday
            ...
            redAlarm={data.redAlarm}
            disableAlarm={data.disableAlarm}
            max={data.horizontal.maxVel}
            min={data.horizontal.minVel}
            value={data.horizontal.instantVel}
            unity={"mm/s"}
            gridArea={"Hor"}
            middle
          />
          ...
          <DashToday
            ...
            redAlarm={data.redAlarm}
            disableAlarm={data.disableAlarm}
            max={data.axial.maxVel}
            min={data.axial.minVel}
            value={data.axial.instantVel}
            unity={"mm/s"}
